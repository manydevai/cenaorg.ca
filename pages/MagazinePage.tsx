...
export function MagazinePage() {
  ...
  const PAGE_IMAGE_MAP: Record<number, string> = {
    ...
    12: '/magazine/pages/MAG_-_ENGLISH_VERSION19.webp',// Candor's Cake (Marileny Fernando Antonio - Pâtisserie)
    13: '/magazine/pages/MAG_-_ENGLISH_VERSION13.webp',// Magalie Sabine Jean-Louis (Imobiliário)
    14: '/magazine/pages/MAG_-_ENGLISH_VERSION14.webp',// Neccy LM (Liderança Feminina)
    15: '/magazine/pages/MAG_-_ENGLISH_VERSION32.webp',// Associação Menarca Muhatu (Divina Ndomateso)
