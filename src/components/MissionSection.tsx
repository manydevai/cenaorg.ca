        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          <div className="lg:col-span-8">
            ...
            <motion.h2
              ...
              className="text-4xl sm:text-6xl font-serif text-[#121212] leading-tight mb-8 tracking-tight"
            >
              {t('mission.title')}
            </motion.h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-gray-100">
          {pillars.map((pillar, index) => (
            <motion.div
              ...
              className="p-12 border-b md:border-b-0 md:border-r border-gray-100 last:border-r-0 group transition-shadow duration-500 hover:bg-[#FBFBFB] relative"
            >
              {/* Decorative Corner */}
              <div
                className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                style={{ borderColor: pillar.color }}
              ></div>

              <div className="mb-10 relative">
                <pillar.icon
                  className="h-12 w-12 transition-transform duration-700 group-hover:scale-110"
