        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 border border-gray-100 mb-24">
          {partnerTypes.map((partner, index) => (
            <motion.div
              ...
              className="p-12 border-b sm:border-b-0 sm:border-r border-gray-100 last:border-r-0 group hover:bg-[#FBFBFB] transition-colors duration-500 cursor-default"
            >
              <div className="mb-12 relative flex items-center justify-center h-24 w-24 border border-gray-100 group-hover:border-[#C5A059] transition-colors duration-500">
                <partner.icon
                  className="h-8 w-8 transition-transform duration-700 group-hover:scale-110"
                  style={{ color: partner.color }}
                />
                <div className="absolute top-0 right-0 w-2 h-2 bg-[#C5A059] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
              <h4 className="text-xs tracking-[0.2em] font-bold text-[#121212] uppercase group-hover:text-[#8B0000] transition-colors duration-500">
                {partner.type}
              </h4>
            </motion.div>
          ))}
