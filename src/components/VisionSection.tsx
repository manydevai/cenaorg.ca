...
export function VisionSection() {
  ...
  return (
    <section id="vision" className="py-24 sm:py-32 bg-gray-50 relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">

        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12 mb-24">
          <div className="max-w-xl">
            <span className="inline-block text-[#C5A059] font-sans text-[10px] tracking-[0.4em] uppercase font-bold mb-6">
              {t('vision.badge')}
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {goals.map((goal, index) => (
            <div key={index} className="bg-white p-12 border border-gray-200 transition-all duration-700 hover:shadow-[30px_30px_0px_[-15px]_rgba(197,160,89,0.1)] group cursor-default">
              <div className="flex justify-between items-start mb-12">
                ...
                <span className="text-4xl font-serif text-gray-100 group-hover:text-gray-200 transition-colors">0{index + 1}</span>
              </div>

              <h3 className="text-xl font-serif mb-6 text-[#121212] uppercase tracking-tighter">{goal.title}</h3>
